...
export class ApiService {
  ...
  getRates(base: string) : Observable<any> {
    ...
    return this.httpClient.get(`https://api.apilayer.com/exchangerates_data/latest?apikey=hZqc0Gi4IrO3TFroyu46FDIe1Rh2CQgi&base=${base}&symbols=USD%2CEUR%2CJPY%2CGBP%2CNGN&base=USD`);
